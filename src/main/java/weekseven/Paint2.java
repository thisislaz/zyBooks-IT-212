...
public class Paint2 {
    ...
    public static void main(String[] args) {
        ...
        // calculating the number of paint cans needed to paint the wall
        cansNeeded = gallonsPaintNeeded / gallonsPerCan;

        // rounding the number of cans needed up to the nearest whole integer
        cansNeeded = Math.ceil(cansNeeded);

        // printing to the console the number of cans needed
